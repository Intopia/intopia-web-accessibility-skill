...
- Disclosure builds on the Interactive Control base; Accordion and Toggletip both build on the Disclosure pattern — load the Interactive Control and Disclosure AC files together with theirs; each file lists only its own additional criteria.
